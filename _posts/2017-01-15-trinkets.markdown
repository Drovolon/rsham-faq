...
- First, after the Jan 24 buffs, I *personally* consider [Perfectly Preserved Cake][cake] to be best-in-slot for the
  ...
  here's how it goes:
    ...
    * Allies just need to walk near the cake (8 yard radius) to get the benefit from the cake - no interaction
      required - but there is a 5 ally limit (plus yourself, an undocumented change (or bug?)).
    * If you drop the cake in a clump of allies, it auto applies to 5 of them (plus yourself) without any action 
      (no movement required)
    * [This picture](/assets/cake-radius.jpg) shows where the trinket drops when you use it relative to your
      character. Yourself plus five allies who are within the green targeting reticle are affected (or if fewer
      than five are originally in the reticle, there is a 20 second window for others to walk within the 8
      yard range and get the buff.)
