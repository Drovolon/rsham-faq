...
[Perfectly Preserved Cake][cake] is strong. The other Nighthold trinkets are probably worse than a stat stick of equivalent
ilevel, with the caveat that getting an equivalent-ilevel stat stick is difficult because of the high base ilevel of the
Nighthold trinkets.
...
- Next, prefer the "stat+proc" trinkets, like:
    * [Etraeus' Celestial Map][map] from Star Augur Etraeus in Nighthold
        ...
        + In my opinion, BiS in dungeons (see below)
    * [Ephemeral Paradox][paradox] from Elisande in Nighthold
        ...
        + Less valuable in dungeons because mana isn't usually a concern there
